...
//Graph API this is VERY messy and needs cleaning up
  window.fbAsyncInit = function() {
    ...
    FB.api(
      '/1061577877320965/events',
      'GET',
      //need to generate permanent possibly from Terrez to access events
      {"fields":"id", access_token: 'EAAGYyLN7BccBAAgwe1WYZC4h2Epr0IKYuYmZCrOsJzjZAE2fao2ASWU4jXGpeoLVDhlTLTpbuEjKaSglARnEbsJqkNFYck04c2npwqu00ehJM1NMOHgDK592wrmYZCI0Ayy9ZB0PDpDp6xTzAIIgOapJ53giZBOi0ZD'},
      function(response) {
